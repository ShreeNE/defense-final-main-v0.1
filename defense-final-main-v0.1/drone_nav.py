...
def main():
    ...
    def draw_navigation():
        ...
        # UI Widgets (draws all registered widgets)
        ui_manager.draw_all(screen)
    ...
    while running:
        ...
        for ev in pygame.event.get():
            ...
            # Keyboard
                ...
                # ---- NODE MARKING state keys ----
                    ...
                    if ev.key == pygame.K_ESCAPE:
                        state = STATE_MODE_SELECT
                        set_status("Returned to menu", CYAN)
                ...
                # ---- NAVIGATING state keys ----
                    ...
                    if ev.key == pygame.K_ESCAPE:
                        state = STATE_MODE_SELECT
                        set_status("Navigation aborted — returned to menu", YELLOW)
        ...
        if state == STATE_LOADING:
            ...
            # In Free Play mode, advance only if not paused
            # In auto-play mode, always advance
